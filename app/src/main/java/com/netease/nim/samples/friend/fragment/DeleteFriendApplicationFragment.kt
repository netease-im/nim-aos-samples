...
class DeleteFriendApplicationFragment : BaseMethodExecuteFragment<FragmentDeleteFriendApplicationBinding>() {
    ...
    override fun createViewBinding(
        ...
        container: ViewGroup?
    ): FragmentDeleteFriendApplicationBinding {
        return FragmentDeleteFriendApplicationBinding.inflate(inflater, container, false)
    }
