...
class AcceptFriendApplicationFragment :
    BaseMethodExecuteFragment<FragmentAcceptFriendApplicationBinding>() {
    ...
    override fun createViewBinding(
        ...
        container: ViewGroup?
    ): FragmentAcceptFriendApplicationBinding {
        return FragmentAcceptFriendApplicationBinding.inflate(inflater, container, false)
    }
